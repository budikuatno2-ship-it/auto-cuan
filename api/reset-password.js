...
const adminPasskeyBrowser = require('../lib/admin-passkey-browser');
...
module.exports = async function handler(req, res) {
  ...
  if (req.method === 'POST' && bodyAction.startsWith('admin-passkey-')) {
    return adminPasskeyBrowser(req, res);
  }
...
module.exports.__test = Object.assign({}, legacy.__test || {}, {
  ...
  adminPasskeyBrowser: adminPasskeyBrowser.__test || {},
