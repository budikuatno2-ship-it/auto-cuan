  ...
  try {
    ...
    if (source === 'chat_mode' && chatMessage) {
      ...
      if (intent === 'follow_up_question') {
        prompt = 'Kamu Auto-Cuan AI. User tanya follow-up singkat tentang saham/indeks yang sudah dianalisis. Jawab LANGSUNG dalam 2-5 kalimat saja. Gunakan data dari konteks. Format: HTML <p class="text-sm text-gray-300"> saja. Boleh <strong> untuk angka penting. JANGAN ulangi full analysis. JANGAN tampilkan Kesimpulan Cepat, decision-card, metric-grid, atau template apapun. Bahasa Indonesia santai, natural, to the point.';
        ...
        prompt = 'Kamu Auto-Cuan AI. User tanya follow-up kontekstual tentang level/target/support/resistance. Jawab LANGSUNG 3-6 kalimat berdasarkan data teknikal. Sebutkan angka spesifik. Jika user sebut level tertentu, jelaskan posisinya relatif terhadap support/resistance.\n\nKonteks: ' + techContext + '\n\nFormat: HTML <p class="text-sm text-gray-300">. Boleh <strong class="text-emerald-400"> positif, <strong class="text-red-400"> risiko. JANGAN gunakan template/card/grid. JANGAN ulangi full analysis. Jawab natural seperti teman trading.';
        if (!fcaConfirmed) prompt += ' JANGAN sebut FCA.';
        maxTokens = 600;
