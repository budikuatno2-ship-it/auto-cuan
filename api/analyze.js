  ...
  try {
    ...
    if (source === 'chat_mode' && chatMessage) {
      ...
      if (contextTicker === 'IHSG') {
        prompt += '\n\n=== PERINGATAN UTAMA: INI BUKAN SAHAM, INI INDEKS ===\nABAIKAN seluruh template stock/emiten di atas. IHSG adalah INDEKS PASAR. JANGAN gunakan template saham.\n\n=== OVERRIDE IHSG/INDEKS — WAJIB DIIKUTI SEPENUHNYA ===\n\nTicker ini adalah IHSG (Indeks Harga Saham Gabungan). Ini adalah indeks market, bukan emiten/saham individual.\n\nLARANGAN MUTLAK (JANGAN TAMPILKAN):\n- Entry / Stop Loss / Take Profit / TP1 / TP2\n- Rencana Trading\n- Broker Summary Manual\n- CTA "Kirim Broker Summary manual"\n- fibo-card / Analisis Fibonacci lengkap\n- Setup Label saham\n- Skenario Trading saham\n- Wording: saham ini, emiten, papan, FCA, board\n- Status "Avoid Dulu" (gunakan "Risk-Off" atau "Wait Confirmation")\n\nWAJIB gunakan: IHSG, indeks, market, tekanan pasar, pelaku pasar\n\nSTRUKTUR OUTPUT IHSG (HANYA INI):\n\n1. <div class="decision-card"><strong>Kesimpulan Cepat IHSG</strong><div class="decision-grid"><div><span>Status Market</span><b>[Risk-Off / Wait Confirmation / Rebound Watch / Breakout Watch]</b></div><div><span>Bias IHSG</span><b>[Bullish / Neutral / Bearish / Mixed]</b></div><div><span>Confidence</span><b>[Low / Medium / High]</b></div><div><span>Sikap</span><b>[Defensive / Wait / Selektif / Pantau]</b></div></div><div class="key-level">Level kunci: R [X] / S [X]</div></div>\n\n2. <p><strong>Ringkasan Market</strong><br>[2 kalimat kondisi market]</p>\n\n3. <div class="metric-grid"><div><strong>Data Teknikal IHSG</strong><br>MA20: [X]<br>MA50: [X]<br>MA100: [X]<br>MA200: [X]<br>Posisi: [X]</div><div><strong>Momentum Market</strong><br>RSI14: [X]<br>Volume: [X]x avg<br>Last: [X]<br>High: [X]<br>Low: [X]</div></div>\n\n4. <div class="level-grid"><div><strong>Resistance IHSG</strong><br>R1: [X]<br>R2: [X]</div><div><strong>Support IHSG</strong><br>S1: [X]<br>S2: [X]</div></div>\n\n5. <div class="scenario-list"><div><strong>Skenario Bullish Market</strong><br>[1 kalimat]</div><div><strong>Skenario Netral</strong><br>[1 kalimat]</div><div><strong>Skenario Koreksi</strong><br>[1 kalimat]</div></div>\n\n6. <div class="trade-plan-grid"><div><strong>Sikap Utama</strong><br>[defensive/wait/selektif]</div><div><strong>Level Konfirmasi</strong><br>[IHSG reclaim X]</div><div><strong>Level Risiko</strong><br>[IHSG breakdown X]</div><div><strong>Implikasi ke Saham</strong><br>[selektif / hindari entry agresif]</div></div>\n\n7. <p><strong>Risk Guard Market</strong><br>[1 kalimat teknikal]</p>\n\n8. <p><strong>Invalidasi</strong><br>[1 kalimat]</p>\n\n9. <div class="summary-rows"><div><span>Status Market</span><b>[X]</b></div><div><span>Bias IHSG</span><b>[X]</b></div><div><span>Sikap</span><b>[X]</b></div><div><span>Alasan</span><b>[1 kalimat]</b></div><div><span>Konfirmasi</span><b>[kondisi]</b></div><div><span>Invalidasi</span><b>[kondisi]</b></div></div>\n\nJANGAN tambahkan section lain di luar struktur di atas untuk IHSG.';
      }
