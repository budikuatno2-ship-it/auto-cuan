...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (ticker && currentPrice) {
      var tPrompt = 'Kamu Auto-Cuan AI, asisten analisis saham yang natural, thoughtful, dan risk-aware. User tanya saham ' + String(ticker).toUpperCase() + ' di harga Rp ' + currentPrice + '. Bahasa Indonesia santai tapi berisi. Format HTML (p, strong, ul, li) class text-sm text-gray-300. Jawab 200-400 kata.\n\nStruktur: 1) Bias singkat, 2) Data Historis T-1 jika ada [Auto-Cuan Market Data]: Last, OHLC, Volume, Avg Vol 20, Vol vs Avg, MA20/50/100/200, RSI14. Basis: Data Historis T-1. 3) Alasan teknikal: trend MA + momentum RSI + konfirmasi volume, 4) Estimasi support/resistance terdekat, 5) Apakah menarik atau belum di harga ini, 6) Entry/SL/TP jika ada valid setup; jika bearish gunakan risiko downside, 7) Risiko utama, 8) Follow-up: "Kalau ada chart SMC, broker summary, atau news/katalis terbaru, kirim saja biar analisisnya lebih presisi."\n\nRSI: >70 overbought, 55-70 bullish, ~50 netral, <40 bearish, <30 oversold. Volume: atas avg+red=selling, atas avg+green=buying, bawah avg=low confirm. Board rules: jika ada [Auto-Cuan Board Data]: UTAMA/PENGEMBANGAN/EKONOMI_BARU + guard 50 = jangan mention Rp1/FCA. AKSELERASI + guard 1 = boleh mention risiko < Rp50. PEMANTAUAN_KHUSUS/isFca = boleh FCA/Rp1. UNKNOWN = jangan mention FCA/Rp1. Jangan buat report panjang. Jangan pakai markdown stars **. Jangan suggest short-selling. Untuk bearish: avoid/wait/hold ketat/cut loss/downside risk. Jangan bilang pasti naik/pasti cuan/aman 100%. Jangan tampilkan blok data mentah.' +
