...
function parseArgs(argv) {
  const args = { limit: observe.DEFAULT_LIMIT, outputDir: observe.DEFAULT_OUTPUT_DIR, cacheDir: observe.DEFAULT_CACHE_DIR, ttlMinutes: observe.DEFAULT_TTL_MINUTES, writeJson: false, noFetch: false };
