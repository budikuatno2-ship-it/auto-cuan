...
function parseArgs(argv) {
  const args = { sampleDate: null, scheduledTime: null, shortlistFile: null, stateDir: null, eventDir: null, publishedDir: null, observationRoot: null, cacheDir: null, productionLockFile: null, maxShortlist: 20, concurrency: 4, timeoutMs: 12000, dryRun: false, json: false, help: false };
...
async function main(argv) {
  ...
  const invalid = args.invalid || !args.sampleDate || !args.scheduledTime || !args.shortlistFile || !Number.isInteger(args.maxShortlist) || args.maxShortlist < 1 || args.maxShortlist > 20 || !Number.isInteger(args.concurrency) || args.concurrency < 1 || args.concurrency > 4 || !Number.isInteger(args.timeoutMs) || args.timeoutMs < 1000 || args.timeoutMs > 30000;
