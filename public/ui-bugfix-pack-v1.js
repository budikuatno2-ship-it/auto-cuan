(function (root, factory) {
  ...
  var STYLE_TEXT = [
    ...
    '   remains untouched. */',
    'html,body{overscroll-behavior-y:auto!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important;}',
    '#dashboardScreen,.page-content{overflow-y:auto!important;-webkit-overflow-scrolling:touch!important;}',
    '#page-screener,#page-dashboard,#page-analisis,#page-sektor,#page-portofolio,#page-watchlist,#page-trackrecord{padding-bottom:88px!important;overflow-y:visible!important;}',
    '#kgCardGrid,#nkCardGrid,#dtCardGrid{padding-bottom:80px!important;margin-bottom:24px!important;overflow:visible!important;}',
