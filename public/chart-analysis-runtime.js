      ...
      .then(function (statusData) {
        ...
        return fetch(API_ENDPOINT + '&action=analyze', {
          ...
          .then(function (result) {
            ...
            cardHtml += '<div><span style="font-size:13px;font-weight:800;color:#fff;display:flex;align-items:center;gap:6px"><span>🤖</span> Analisis Chart (AI) — ' + escapeHtml(ticker) + '</span><span style="font-size:10px;color:#94a3b8">Model: ' + escapeHtml(analysisData.model || 'Gemini 2.5') + (result.cached ? ' · (Cache Hari Ini)' : '') + '</span></div>';
