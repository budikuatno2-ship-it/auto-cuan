...
| `api/sector-hot.js` | 13902 | SEDANG | 4 | baris 1-6700 dari 13902 dibaca. Temuan: BUG-018 (DIPERBAIKI #502), BUG-017, BUG-019 (2 instance drift gate/diagnostik), sumber data BUG-016 (DIPERBAIKI #503). Verifikasi bersih: gate keselamatan publik :4285-5085 (semua gagal-tertutup; lookup objek literal aman dari prototype pollution karena kunci huruf besar), token share HMAC + expiry WIB :2421-2560, token chart Top5 HMAC + TTL :5628-5650, parser CSV foreign :3440-3560, helper WIB/Jakarta :3320-3480, escapeSvgText :5486, fetchLatestPriceForMonitor :6597 (sengaja tidak mengarang high/low intraday). Catatan laten: fallback alias entry tertukar :4024-4025. Menguatkan BUG-014 (:1482/:2016) dan BUG-015 (calcScreenerRSI :3360, rsiData :5583) |
