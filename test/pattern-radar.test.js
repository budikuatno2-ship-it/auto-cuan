...
test('dashboard loads tab-resume guard before stable Pattern v4 and cache-busted Screener extension v6', () => {
  ...
  assert.match(loader, /\/pattern-stable-runtime\.js\?v=20260802-pattern-stable-v4/);
