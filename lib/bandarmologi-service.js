...
function normalizeVwapPrice(raw, refPrice) {
  ...
  // Di papan FCA / Akselerasi, harga saham sah diperdagangkan di bawah Rp 50 (antara Rp 1 - Rp 50).
  // Jangan paksa pengali 100x jika raw >= 1 karena akan menggelembungkan saham penny (misal Rp 42 -> Rp 4200).
  if (raw < 1 && raw * 100 >= 1 && raw * 100 <= 50000) {
    return Math.round(raw * 100);
  }
  return Math.round(raw);
}
