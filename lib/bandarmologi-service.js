...
function normalizeBrokerSummary(raw, date, ticker) {
  ...
  const netStatus = isAccumulation ? 'BIG_ACCUMULATION' : 'BIG_DISTRIBUTION';
  const netLabel = isAccumulation ? 'Big Accumulation' : 'Big Distribution';
