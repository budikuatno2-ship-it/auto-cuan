...
function getDynamicTradingDays(count = 10) {
  try {
    const dates = idxTradingCalendar.getLastTradingDays(new Date(), count);
    if (dates && dates.length > 0) return dates;
  } catch (_) {}
  return ['2026-09-08', '2026-09-07', '2026-09-04', '2026-09-03', '2026-09-02', '2026-09-01', '2026-08-28', '2026-08-27'];
}
...
function generateDemoData(ticker, date) {
  const dynamicDays = getDynamicTradingDays(10);
  const safeDate = date || dynamicDays[0] || '2026-09-08';
  const grossBuyers = [
    ...
    { broker: 'KZ', broker_name: 'CLSA Sekuritas Indonesia', bval: 38220000000, sval: 28220000000, bvol: 3900000, svol: 2880000, bfrq: 980, sfrq: 670, nval: 10000000000, nvol: 1020000, buy_vol: 3900000, buy_val: 38220000000, avg_price: 9800, net_val: 10000000000 },
    { broker: 'ZP', broker_name: 'Maybank Sekuritas Indonesia', bval: 34300000000, sval: 25300000000, bvol: 3500000, svol: 2580000, bfrq: 890, sfrq: 610, nval: 9000000000, nvol: 920000, buy_vol: 3500000, buy_val: 34300000000, avg_price: 9800, net_val: 9000000000 },
    { broker: 'RX', broker_name: 'Macquarie Sekuritas Indonesia', bval: 29400000000, sval: 21400000000, bvol: 3000000, svol: 2180000, bfrq: 780, sfrq: 520, nval: 8000000000, nvol: 820000, buy_vol: 3000000, buy_val: 29400000000, avg_price: 9800, net_val: 8000000000 },
    { broker: 'DR', broker_name: 'RHB Sekuritas Indonesia', bval: 24500000000, sval: 18500000000, bvol: 2500000, svol: 1890000, bfrq: 650, sfrq: 450, nval: 6000000000, nvol: 610000, buy_vol: 2500000, buy_val: 24500000000, avg_price: 9800, net_val: 6000000000 },
    { broker: 'AI', broker_name: 'UOB Kay Hian Sekuritas', bval: 19600000000, sval: 14600000000, bvol: 2000000, svol: 1490000, bfrq: 540, sfrq: 390, nval: 5000000000, nvol: 510000, buy_vol: 2000000, buy_val: 19600000000, avg_price: 9800, net_val: 5000000000 }
  ];
  const grossSellers = [
    ...
    { broker: 'SQ', broker_name: 'BCA Sekuritas', sval: 25480000000, bval: 16480000000, svol: 2600000, bvol: 1680000, sfrq: 920, bfrq: 540, nval: -9000000000, nvol: -920000, sell_vol: 2600000, sell_val: 25480000000, avg_price: 9800, net_val: -9000000000 },
    { broker: 'KK', broker_name: 'Phillip Sekuritas Indonesia', sval: 21560000000, bval: 14560000000, svol: 2200000, bvol: 1480000, sfrq: 810, bfrq: 480, nval: -7000000000, nvol: -720000, sell_vol: 2200000, sell_val: 21560000000, avg_price: 9800, net_val: -7000000000 },
    { broker: 'XL', broker_name: 'Stockbit Sekuritas', sval: 18620000000, bval: 12620000000, svol: 1900000, bvol: 1290000, sfrq: 720, bfrq: 410, nval: -6000000000, nvol: -610000, sell_vol: 1900000, sell_val: 18620000000, avg_price: 9800, net_val: -6000000000 },
    { broker: 'AZ', broker_name: 'Sucor Sekuritas', sval: 15680000000, bval: 10680000000, svol: 1600000, bvol: 1090000, sfrq: 630, bfrq: 360, nval: -5000000000, nvol: -510000, sell_vol: 1600000, sell_val: 15680000000, avg_price: 9800, net_val: -5000000000 },
    { broker: 'OD', broker_name: 'BRI Danareksa Sekuritas', sval: 12740000000, bval: 8740000000, svol: 1300000, bvol: 890000, sfrq: 520, bfrq: 290, nval: -4000000000, nvol: -410000, sell_vol: 1300000, sell_val: 12740000000, avg_price: 9800, net_val: -4000000000 }
  ];
  ...
  return {
    ...
    insiders: [
      ...
      },
      {
        ...
        price: 9600,
        shares: 2500000,
        shares_change: 2500000,
        pct_change: '+0.021%',
        shares_after: 61500000000,
        pct_after: '49.82%',
        shares_before: 61497500000,
        pct_before: '49.80%',
        nationality: 'local'
      },
      {
        date: '2026-08-10',
        name: 'Institutional Fund Partners',
        position: 'Investor Institusi',
        action_type: 'SELL',
        broker: 'AK',
        price: 9825,
        shares: 1000000,
      ...
      },
      {
        ...
        pct_change: '+0.001%',
        shares_after: 1520000,
        pct_after: '0.012%',
        shares_before: 1400000,
        pct_before: '0.011%',
        nationality: 'foreign'
      }
    ]
...
function normalizeInsiders(raw) {
  ...
  return list.map(item => {
    ...
    // 6. Percentage change
    const pctChange = item.changes_percentage || item.pct_change || item.percentage_change || '—';

    // 7. Shares after & before
    const sharesAfter = toNumericOrNull(item.shares_after) ?? toNumericOrNull(item.current_shares) ?? toNumericOrNull(item.volume_after) ?? toNumericOrNull(item.after_value);
    const pctAfter = item.shares_after_percentage || item.current_shares_percentage || item.after_percentage || item.pct_after || null;

    let sharesBefore = toNumericOrNull(item.shares_before) ?? toNumericOrNull(item.previous_shares) ?? toNumericOrNull(item.volume_before) ?? toNumericOrNull(item.before_value);
    ...
    const pctBefore = item.shares_before_percentage || item.previous_shares_percentage || item.before_percentage || item.pct_before || null;
    ...
    return {
      ...
      name: name,
      insider_name: name,
      position: (item.badges && item.badges[0]) || item.position || item.jabatan || '—',
      action_type: actionType,
      broker: broker,
      price: price,
      shares: sharesChange, // backward compatibility
...
async function getBandarmologiData(tickerOrQuery, options = {}) {
  ...
  demo.range = range;
  demo.available_dates = getDynamicTradingDays(10);
