...
function validRadarPlan(plan) {
  ...
  if (plan.internal_status !== 'READY_PENDING' && plan.internal_status !== 'SPIKE_RADAR' && (plan.watch_score == null || plan.watch_score < MIN_RADAR_WATCH_SCORE)) return false;
