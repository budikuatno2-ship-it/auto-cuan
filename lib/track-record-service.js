...
function buildTrackRecordData(rows = [], options = {}) {
  const categoryStats = {
    daytrade: { key: 'daytrade', label: 'Day Trade', total: 0, tp1_hits: 0, tp2_hits: 0, sl_hits: 0, running: 0, waiting: 0, expired: 0, win_rate_tp1: '0.0%', win_rate_tp2: '0.0%', sl_rate: '0.0%' },
    swing_konglo: { key: 'swing_konglo', label: 'Swing Konglo', total: 0, tp1_hits: 0, tp2_hits: 0, sl_hits: 0, running: 0, waiting: 0, expired: 0, win_rate_tp1: '0.0%', win_rate_tp2: '0.0%', sl_rate: '0.0%' },
    swing_nk: { key: 'swing_nk', label: 'Swing Non-Konglo', total: 0, tp1_hits: 0, tp2_hits: 0, sl_hits: 0, running: 0, waiting: 0, expired: 0, win_rate_tp1: '0.0%', win_rate_tp2: '0.0%', sl_rate: '0.0%' },
    top5: { key: 'top5', label: 'Top 5 Daily Picks', total: 0, tp1_hits: 0, tp2_hits: 0, sl_hits: 0, running: 0, waiting: 0, expired: 0, win_rate_tp1: '0.0%', win_rate_tp2: '0.0%', sl_rate: '0.0%' }
  };
