...
function scoreDayTrade(data, runMode, board, candleResult) {
  ...
  if (planQuality.plan_quality_status === 'INVALID') {
    confidence = 'C';
    entryTiming = 'Hindari — setup tidak valid';
    classification.status = 'AVOID';
    classification.setup = 'Invalid / Wait';
  ...
  var riskV2ForGuard = idxTick.deriveRiskLabelV2(Object.assign({}, data, levels, entryStatus, planQuality, {
    mode: 'daytrade',
  ...
  var signalVerdict = idxTick.deriveSignalVerdict(Object.assign({}, data, levels, entryStatus, planQuality, riskV2ForGuard, {
    mode: 'daytrade',
