...
function formatSignalCard(r, idx, mode) {
  ...
  if (_tpv2Public) {
    // Values are read straight from the canonical trade_plan_v2 — never recomputed
    // here — so the website and Telegram display identical numbers.
    var _c = _tpv2Public.canonical;
    var _d = _tpv2Public.display;
    lines.push('Entry: ' + _d.entry_zone);
    lines.push('Support: ' + _d.support + ' / Resistance: ' + _d.resistance);
    lines.push('Stop Loss: ' + _d.stop_loss);
