...
function getBandarTrendLabel(netA, netB, net1m, net3m) {
  ...
  if (netA < 0 && netB === 0 && !(net1m != null && net1m > 0) && !(net3m != null && net3m > 0)) return 'Distribution';
  if (netA > 0 && netB > 0) {
    if ((net1m != null && net1m < 0) || (net3m != null && net3m < 0)) {
      return 'Mixed';
    }
    return 'Accumulation';
  }
...
function computeBandarmologiConfluence(ticker) {
  ...
  const net1m = windowSums['1m'];
  const net3m = windowSums['3m'];

  const label = getBandarTrendLabel(net3d != null ? net3d : (net7d != null ? net7d : 0), net7d != null ? net7d : (net3d != null ? net3d : 0), net1m, net3m);
  let notes;
