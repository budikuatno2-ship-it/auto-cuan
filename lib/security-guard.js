...
async function recordBlockedHit(db, context, precheck, mode) {
  ...
  // A shadow-block may continue into a normal failure/success event. Give the
  // blocked-hit audit its own deterministic suffix so the unique request_id never
  // suppresses the later credential outcome.
