...
function detectPriceBelowBandarCost(ticker, options = {}) {
  ...
  if (!currentPrice || currentPrice <= 0) {
    return {
      ...
      top_3_brokers: top3.map(b => ({
        ...
        avg_price: bandarmologiService.normalizeVwapPrice(b.avg_price || b.avg_buy || b.avg_buy_price || (Number(b.buy_val || b.bval || 0) / Number(b.buy_vol || b.bvol || 1)), refPrice)
      })),
  ...
  const top3Formatted = top3.map(b => {
    ...
    } else if (b.avg_price || b.avg_buy || b.avg_buy_price || b.bavg) {
      p = bandarmologiService.normalizeVwapPrice(b.avg_price || b.avg_buy || b.avg_buy_price || b.bavg, refPrice);
    }
    return {
      broker: b.broker,
      broker_name: b.broker_name || getBrokerFullName(b.broker),
