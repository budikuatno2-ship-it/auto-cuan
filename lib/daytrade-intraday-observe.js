...
function calculateIntradayScorePreview(fields) {
  ...
  if (dataQuality === 'STALE_CACHE') { raw -= 3; reasons.push('STALE_CACHE -3'); }
  else if (dataQuality === 'INCOMPLETE_INTRADAY') { raw -= 2; reasons.push('INCOMPLETE_INTRADAY -2'); }
  else if (dataQuality === 'NO_INTRADAY_DATA') reasons.push('NO_INTRADAY_DATA 0');
