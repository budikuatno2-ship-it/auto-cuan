...
const RAW_GEMINI_MODEL = (process.env.GEMINI_MODEL || '').trim();
const DEFAULT_GEMINI_MODEL = (RAW_GEMINI_MODEL && RAW_GEMINI_MODEL !== 'gemini-3-flash') ? RAW_GEMINI_MODEL : 'gemini-2.5-flash';
const RAW_FALLBACK_MODEL = (process.env.GEMINI_FALLBACK_MODEL || '').trim();
const FALLBACK_GEMINI_MODEL = (RAW_FALLBACK_MODEL && RAW_FALLBACK_MODEL !== 'gemini-3.1-flash-lite') ? RAW_FALLBACK_MODEL : 'gemini-2.0-flash';
