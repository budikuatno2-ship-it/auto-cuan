...
async function deliverOneChunk(input,d,reply,sender,batch){
 ...
 }catch(_){await d.db.rpc('cancel_voucher_admin_batch_chunk',{p_batch_reference:batch.batch_reference,p_chunk_index:chunk.chunk_index,p_attempt_id:chunk.attempt_id,p_claim_token:chunk.claim_token});return {outcome:'delivery_failed',generated:0};}
}
