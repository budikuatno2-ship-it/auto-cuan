...
subscription_telegram_link_token_created: ['request_id'], subscription_telegram_linked: ['telegram_user_id'], subscription_telegram_link_rejected: ['reason'], subscription_voucher_created: ['voucher_reference','code_hint','voucher_type','source_channel'], subscription_voucher_disabled: ['voucher_reference','result_code','source_channel'], subscription_voucher_quote_requested: ['voucher_reference','voucher_type','plan_code','discount_percent','normal_price_idr','final_price_idr','source_channel'], subscription_voucher_quote_rejected: ['result_code','source_channel'], subscription_voucher_redeemed: ['voucher_reference','voucher_type','plan_code','discount_percent','normal_price_idr','final_price_idr','result_code','source_channel','redemption_count','starts_at','expires_at'], subscription_voucher_redemption_rejected: ['result_code','source_channel'], subscription_lifetime_voucher_redeemed: ['voucher_reference','voucher_type','plan_code','lifetime_seat_number','source_channel'], account_auto_approved_by_voucher: ['previous_approval_state','new_approval_state']
};
const TYPES = { voucher_reference: 'string', code_hint: 'string', voucher_type: 'string', source_channel: 'string', result_code: 'string', plan_code: 'string', discount_percent: 'number', normal_price_idr: 'number', final_price_idr: 'number', redemption_count: 'number', lifetime_seat_number: 'number', starts_at: 'string', expires_at: 'string', previous_approval_state: 'string', new_approval_state: 'string', request_id: 'string', reason: 'string', telegram_user_id: 'number', plan_code: 'string', change_reason: 'string', promo_starts_at: 'string', promo_ends_at: 'string', previous_price_version: 'number', new_price_version: 'number', previous_normal_price_idr: 'number', new_normal_price_idr: 'number', previous_promo_price_idr: 'number', new_promo_price_idr: 'number', previous_promo_enabled: 'boolean', new_promo_enabled: 'boolean' };
