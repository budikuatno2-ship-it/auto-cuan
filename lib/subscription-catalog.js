...
const EVENT_FIELDS = {
  ...
  subscription_email_otp_requested: ['request_id'], subscription_email_verified: ['verification_version'], subscription_email_verification_failed: ['reason'],
  subscription_telegram_link_token_created: ['request_id'], subscription_telegram_linked: ['telegram_user_id'], subscription_telegram_link_rejected: ['reason']
};
const TYPES = { request_id: 'string', verification_version: 'number', reason: 'string', telegram_user_id: 'number', plan_code: 'string', change_reason: 'string', promo_starts_at: 'string', promo_ends_at: 'string', previous_price_version: 'number', new_price_version: 'number', previous_normal_price_idr: 'number', new_normal_price_idr: 'number', previous_promo_price_idr: 'number', new_promo_price_idr: 'number', previous_promo_enabled: 'boolean', new_promo_enabled: 'boolean' };
