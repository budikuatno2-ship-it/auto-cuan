...
function deriveIdxAutoRejectLevels(input) {
  ...
  else if (out.tp1_intraday_realistic) out.tp_realism_note = out.tp2_intraday_realistic ? 'TP1 realistis · TP2 lanjutan/multi-day.' : 'TP1 realistis.';
...
function deriveCandlePotentialRange(input) {
  ...
  else if (tp1Real) realism = tp2Real ? 'TP1 realistis · TP2 lanjutan/multi-day.' : 'TP1 realistis.';
