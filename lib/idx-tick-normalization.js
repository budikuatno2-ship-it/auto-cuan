...
function deriveSetupFreshness(candidate, opts) {
  candidate = candidate || {};
  opts = opts || {};
  var ts = candidate.freshness_timestamp || candidate.calculated_at || candidate.run_at || candidate.updated_at || candidate.last_checked_at || candidate.created_at || opts.calculated_at || opts.updated_at || opts.created_at || candidate.first_sent_at || null;
  var price = firstNum(candidate, ['current_price', 'last_price', 'lastn', 'close']);
