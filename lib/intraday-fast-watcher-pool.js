...
const RULE_VERSION = 'FAST_WATCHER_ADAPTIVE_MOMENTUM_V6';
...
function process(options) {
  ...
  for (const row of rows) {
    ...
    if (structureReason) result = Object.assign({}, result, { passes: false, status: 'INVALID_DATA', reasons: [structureReason] });
...
module.exports = { RULE_VERSION, INITIAL_WATCH_MINUTES, WATCH_EXTENSION_MINUTES, MAX_WATCH_MINUTES, REQUIRED_CONFIRMATIONS, CONFIRMATION_WINDOW_SIZE, MIN_FRESH_SHORTLIST_SLOTS, MAX_PUBLISH_COUNT, SUPPLEMENTAL_STATUSES, canonicalSetupMetrics, structuralSetupReason, resetTrackerForReentry, activeRows, mergePayload, process, rankPublishable, setupId, lockSetup, withLockedSetup };
