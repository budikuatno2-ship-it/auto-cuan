...
function createInteractiveBot(options) {
  ...
  async function requireApproved(ctx) {
    ...
    // Gatekeeper guard: an unverified sender gets ONLY the hold message with the
    // deep-link verification button. No command is ever processed and no account
    // verification instruction is issued from THIS bot.
