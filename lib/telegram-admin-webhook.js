...
async function processUpdate(update, deps) {
  ...
  } catch (error) { await deps.service.releaseUpdate(update.update_id).catch(function(){}); throw error; }
}
...
module.exports={handle,processUpdate,command,parseVoucher,paymentText,voucherText,equalSecret,buttons,MAX_BODY};
