...
const STATUSES = new Set(['REJECTED', 'PASSED', 'WATCH', 'CANDIDATE', 'ELIGIBLE', 'PUBLISHED']);
const TOP_LEVEL_KEYS = new Set(['schema_version', 'strategy', 'run_id', 'run_mode', 'scheduled_slot', 'scheduler_source', 'code_sha', 'config_hash', 'ticker', 'candidate_revision', 'observed_at', 'feature_as_of_ts', 'feature_as_of_provenance', 'data_source', 'data_lag_ms', 'ohlcv_sofar', 'rvol_raw', 'rvol_seasonal', 'rvol_seasonal_provenance', 'score_components_raw', 'score_raw', 'score_display', 'status', 'passed', 'rejection_codes', 'gate_trace', 'levels', 'publication']);
const REQUIRED_KEYS = ['schema_version', 'strategy', 'run_id', 'run_mode', 'scheduled_slot', 'scheduler_source', 'code_sha', 'config_hash', 'ticker', 'candidate_revision', 'observed_at', 'feature_as_of_ts', 'feature_as_of_provenance', 'data_source', 'data_lag_ms', 'ohlcv_sofar', 'rvol_raw', 'rvol_seasonal', 'rvol_seasonal_provenance', 'score_components_raw', 'score_raw', 'score_display', 'status', 'passed', 'rejection_codes', 'gate_trace', 'levels', 'publication'];
...
function normalizeEvaluationRecord(record) {
  ...
  boundedString(record.run_mode, 'run_mode', 64); boundedString(record.scheduled_slot, 'scheduled_slot', 64, true); boundedString(record.scheduler_source, 'scheduler_source', 128, true); boundedString(record.data_source, 'data_source', 128);
