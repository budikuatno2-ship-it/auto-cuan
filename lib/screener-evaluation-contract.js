...
const TOP_LEVEL_KEYS = new Set(['schema_version', 'strategy', 'run_id', 'run_mode', 'batch_index', 'scheduled_slot', 'scheduler_source', 'code_sha', 'config_hash', 'ticker', 'candidate_revision', 'observed_at', 'feature_as_of_ts', 'feature_as_of_provenance', 'data_source', 'data_lag_ms', 'ohlcv_sofar', 'rvol_raw', 'rvol_seasonal', 'rvol_seasonal_provenance', 'score_components_raw', 'score_raw', 'score_display', 'status', 'passed', 'rejection_codes', 'gate_trace', 'levels', 'publication']);
const REQUIRED_KEYS = ['schema_version', 'strategy', 'run_id', 'run_mode', 'batch_index', 'scheduled_slot', 'scheduler_source', 'code_sha', 'config_hash', 'ticker', 'candidate_revision', 'observed_at', 'feature_as_of_ts', 'feature_as_of_provenance', 'data_source', 'data_lag_ms', 'ohlcv_sofar', 'rvol_raw', 'rvol_seasonal', 'rvol_seasonal_provenance', 'score_components_raw', 'score_raw', 'score_display', 'status', 'passed', 'rejection_codes', 'gate_trace', 'levels', 'publication'];
