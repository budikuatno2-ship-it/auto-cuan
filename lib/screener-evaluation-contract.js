...
const INITIAL_THRESHOLDS = require('./daytrade-screener-constants').INITIAL_CLASSIFICATION_THRESHOLDS;
...
function normalizeEvaluationRecord(record) {
  ...
  if (record.passed !== (record.score_display >= INITIAL_THRESHOLDS.persistence_score)) throw new TypeError('passed contradicts the production score threshold');
