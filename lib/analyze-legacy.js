...
function sanitizeOutput(html, fcaConfirmed, intent) {
  ...
  output = convertMarkdownBold(output);
...
// Converts raw markdown bold (**text**) leaking from Gemini/DeepSeek vision
// responses into <strong> tags. Shared by every raw-text AI vision handler
// below so none of them regress back to showing literal ** to the user.
