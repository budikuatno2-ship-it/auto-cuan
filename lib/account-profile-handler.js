...
module.exports = async function accountProfileHandler(req, res) {
  ...
  return res.status(200).json({
    ...
    profile: {
      ...
      // Overall "Terverifikasi" badge: true if verified through ANY supported
      // channel. Only Telegram exists today; a future email-verification flag
      // should be OR-ed in here too, not replace it.
      verified_badge: Boolean(telegram && telegram.verified),
      telegram,
      terms: {
