 ...
 *
 * STATUS: OBSERVE-ONLY — integrated into VPS observe worker only.
 * NOT used by the production daytrade-screener-run endpoint (Vercel).
 * Production endpoint (api/sector-hot?action=daytrade-screener-run) does not
 * call this module. To make it production-active, the Vercel endpoint would
 * need explicit integration (future work).
 *
